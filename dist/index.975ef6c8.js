...
function sendEmail() {
    ...
    if (message.length === 0 || fromName.length === 0 || fromEmail.length === 0) alert("The fields cant be empty");
    else emailjs.send("service_id4zm7b", "template_6zcmbew", {
        from_name: document.getElementById("name").value,
        from_email: document.getElementById("email").value,
        message: document.getElementById("message").value
    }, "Iius2lM9EnowdV6Rt").then(function(response) {
